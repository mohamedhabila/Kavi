...
export async function executeContactsGet(args: { id: string }): Promise<ToolRuntimeOutcome> {
  return executeStructuredNativeAction('contacts_get', args as Record<string, unknown>);
}

export async function executeContactsPick(): Promise<ToolRuntimeOutcome> {
  return executeStructuredNativeAction('contacts_pick');
}

export async function executeContactsManageAccess(): Promise<ToolRuntimeOutcome> {
  return executeStructuredNativeAction('contacts_manage_access');
}

export async function executeContactsView(args: { id: string }): Promise<ToolRuntimeOutcome> {
  return executeStructuredNativeAction('contacts_view', args as Record<string, unknown>);
}

export async function executeContactsEdit(
  args: Record<string, unknown>,
): Promise<ToolRuntimeOutcome> {
  return executeStructuredNativeAction('contacts_edit', args);
}

export async function executeContactsCreate(
  args: Record<string, unknown>,
): Promise<ToolRuntimeOutcome> {
...
export async function executeContactsGetFull(args: { id: string }): Promise<ToolRuntimeOutcome> {
