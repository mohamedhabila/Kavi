...
export function createAgentControlGraphActions() {
  return {
    recordModelTurnStarted: assignAgentControlGraph(
    ...
    recordModelTurnCompletedWithTools: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => {
    ...
    recordModelTurnCompletedWithoutTools: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => {
        if (event.type !== 'MODEL_TURN_COMPLETED') {
          return {};
        }
    ...
    recordModelTurnFailed: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => {
    ...
    recordModelTurnInvalidated: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => {
    ...
    recordToolResults: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => {
    ...
    clearCompletedToolBoundary: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => ({
        expectedToolCalls: [],
        observedToolResults: [],
        updatedAt: getTimestamp(event),
    ...
    recordFinalizationHold: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => {
    ...
    recordFinalCandidateReady: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => {
    ...
    recordGoalsUpdated: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => {
    ...
    recordRequestUnderstandingProjected: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => {
        ...
        return {
          ...
          updatedAt: getTimestamp(event),
          audit: appendAudit(context.audit, event, `integrity:${requestUnderstanding.integrity}`),
        };
      },
    ),
    ...
    recordSessionActivatedToolsUpdated: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => {
    ...
    recordGoalEvidenceAdded: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => {
    ...
    recordObservabilityAudit: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => {
    ...
    recordPerformanceMetrics: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => {
    ...
    recordTurnDirectives: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => {
    ...
    consumeTurnDirectives: assignAgentControlGraph(
      ({ context, event }: AgentControlGraphAssignArgs) => {
