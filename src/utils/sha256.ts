...
function paddedSha256Bytes(value: string): Uint8Array {
...
/** Small dependency-free SHA-256 for synchronous SQLite lineage transactions. */
export function sha256HexUtf8(value: string): string {
  const bytes = paddedSha256Bytes(value);
