...
export const LOCAL_EVIDENCE_PROMPT_ADDITIVE_LIMIT = LOCAL_EVIDENCE_EXPANSION_LIMITS.promptChars;
export const LOCAL_EVIDENCE_PROMPT_FLATTEN_SEPARATOR_CHARS = 2;
export const LOCAL_EVIDENCE_PROMPT_SECTION_LIMIT =
  LOCAL_EVIDENCE_PROMPT_ADDITIVE_LIMIT - LOCAL_EVIDENCE_PROMPT_FLATTEN_SEPARATOR_CHARS;
