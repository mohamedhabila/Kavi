...
export function ensureCanonicalFactTable(db: MemoryDatabase): void {
  ...
  const canonicalSchemaObjects = new Set([
    ...
    'idx_facts_provider_embedding_current',
  ]);
  ...
  try {
    ...
    db.execSync(`
      ...
      CREATE TABLE memory_facts_without_hash_constraint (
        ...
        provider_embedding_model TEXT,
        provider_embedding_dimensions INTEGER,
        provider_embedding_vector TEXT,
      ...
      INSERT INTO memory_facts_without_hash_constraint (
        ...
        provider_embedding_model, provider_embedding_dimensions, provider_embedding_vector,
        provider_embedding_updated_at,
