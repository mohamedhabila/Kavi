/**
 * ANSI escape sequence handling and grapheme-aware text measurement.
 *
 * Utilities for stripping ANSI SGR/OSC-8 sequences, measuring visible text
 * width with emoji/CJK/combining-mark handling, and sanitizing untrusted
 * text for safe single-line log and terminal rendering.
 */
