...
- `Maintainer-attested first-party lineage`: the code predates this public release but remains first-party Kavi code. For this inventory, these modules were reviewed as maintainer-owned first-party code and are published under this repository's MIT license.
...
| `src/services/media/service.ts`, `src/engine/toolResultGuard.ts`, `src/engine/toolResultPairingGuard.ts`, `src/engine/loopDetection.ts`                | Earlier first-party Kavi runtime and orchestration history                                                   | Maintainer-attested first-party lineage | MIT     | These runtime guardrails were reviewed as internal project code retained across earlier first-party iterations rather than third-party imports.                                                                          |
| `src/i18n/locales/*.ts`                                                                                                                                | Earlier first-party Kavi localization baseline                                                               | Maintainer-attested first-party lineage | MIT     | The localization baseline originated before this public release and remains a first-party project asset.                                                                                                                |
